...
import { KEYBOARD_CONTROLS } from "./keyboardControl";
const OFFSET = 100;
const colorArray = ["#FF6633","#FFB399","#FFFF99","#00B3E6","#E6B333","#3366E6","#999966","#99FF99","#B34D4D","#80B300","#809900","#E6B3B3","#6680B3","#66991A","#FF99E6","#CCFF1A","#FF1A66","#E6331A","#33FFCC",];
const SquareBox = (props) => {
    ...
    return (<div  id={id} tabIndex={0} ref={boxRef} onBlur={handleOnBlur} onSelect={handleOnClick} onKeyUp={handleKeyPress} onKeyPressCapture={handleKeyPress} className={classes.boxContainer} style={{ zIndex: Number(id),backgroundColor: colorArray[id % 20]  }}>
      ID:{id}
    </div>);
};
